...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { name: @provider.name, specialty: @provider.specialty } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { name: @provider.name, specialty: @provider.specialty } }
