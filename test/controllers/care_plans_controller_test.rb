...
class CarePlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create care_plan" do
    assert_difference('CarePlan.count') do
      post care_plans_url, params: { care_plan: { date: @care_plan.date, fee_schedule_id: @care_plan.fee_schedule_id, patient_id: @care_plan.patient_id, status_id: @care_plan.status_id } }
    end
  ...
  test "should update care_plan" do
    patch care_plan_url(@care_plan), params: { care_plan: { date: @care_plan.date, fee_schedule_id: @care_plan.fee_schedule_id, patient_id: @care_plan.patient_id, status_id: @care_plan.status_id } }
